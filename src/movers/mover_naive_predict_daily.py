...
from core.etl.movers.extract import extract_naive_model
from core.etl.movers.load import load_detection_to_datahub
from core.etl.movers.transform.predict import batch_naive_detect
...
def predict_mover(
    ...
    mover_detect = extract_naive_model(pth_util_data, **d_params['model']) 
    
    # Batch predict
    df_movers = batch_naive_detect(df_sentences, mover_detect, batch_size)
